...
export class Config {
  debugLogging = 'debug';
  'server.port' = '8081';
  'jhipster.clientApp.name' = 'd24h_demo';
  ...
  'jhipster.mail.from' = 'd24h_demo@localhost';
  'jhipster.swagger.default-include-pattern' = '/api/.*';
  'jhipster.swagger.title' = 'd24h_demo API';
  'jhipster.swagger.description' = 'd24h_demo API documentation';
  ...
  'eureka.instance.appname' = 'd24h_demo';
  'eureka.instance.instanceId' = 'd24h_demo:${random.value}';
